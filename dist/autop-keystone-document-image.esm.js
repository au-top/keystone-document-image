...
function UploadFile(_ref) {
  ...
  return jsx("div", null, jsx(ToastProvider, null, jsx(BigImageItemPlaceholder, {
...
function BigImageDrawer(_ref4) {
  ...
  var listItems = loading || error ? [] : data[list.gqlNames.listQueryName].map(function (item) {
    return jsx(ToastProvider, null, jsx(BigImageItem, {
      key: item.id,
      item: item,
  ...
  }, error ? jsx("div", null, "\u53D1\u751F\u9519\u8BEF: ", error === null || error === void 0 ? void 0 : error.message) : jsx("div", null, jsx("div", {
    css: {
      padding: "20px 0 0 0",
      display: "flex",
  ...
  }, jsx("div", null, "\u663E\u793A", " ", jsx("strong", null, data[list.gqlNames.listQueryName].length), " ", "\u5173\u4E8E ", data[list.gqlNames.listQueryCountName], " \u56FE\u7247"), selected.length > 0 && jsx(Button, {
    tone: "negative",
    size: "small",
    onClick: function onClick() {
      return deleteItems();
    }
  }, "\u5220\u9664")), jsx(BigImageItemsWrapper, null, jsx(UploadFile, {
    listKey: listKey,
...
var BigImageView = function BigImageView(_ref4) {
  ...
  return jsx("div", null, value.length > 0 ? jsx(BigImageItemsWrapper, null, listItems) : jsx(BigImageItemsWrapper, null, jsx(BigImageItemPlaceholder, null)), jsx(Button, {
    onClick: function onClick() {
      return setIsModalOpen(true);
    }
  }, jsx("span", null, "\u6DFB\u52A0\u56FE\u7247")), jsx(BigImageDrawer, {
    listKey: listKey,
    isOpen: isModalOpen,
    ...
    return {
      ...
      Input: function Input(_ref2) {
        var value = _ref2.value,
            ...
            _ref2.autoFocus;
        return /*#__PURE__*/React.createElement(FieldContainer, null, /*#__PURE__*/React.createElement(BigImageView, {
          listKey: listKey,
          value: value,
          onChange: function onChange(items) {
...
var BigImage = function BigImage(_ref3) {
  ...
  return component({
    preview: function preview(props) {
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(NotEditable, null, props.fields.items.value.length > 0 ? /*#__PURE__*/React.createElement(BigImageItemsWrapper, null, props.fields.items.value.map(function (image) {
        return /*#__PURE__*/React.createElement(BigImageItem, {
          key: image.id,
          item: image
        });
      })) : /*#__PURE__*/React.createElement(BigImageItemsWrapper, null, /*#__PURE__*/React.createElement(BigImageItemPlaceholder, null))), /*#__PURE__*/React.createElement("div", {
        style: {
